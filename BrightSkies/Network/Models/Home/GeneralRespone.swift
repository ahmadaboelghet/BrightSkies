...
struct GeneralRespone: Codable {
    ...
    let undeliverableIngredients: [JSONAny]
    
    enum CodingKeys: String, CodingKey {
        case id, fats, name, time, image, weeks, carbos, fibers, rating, country, ratings, calories, headline, keywords, products, proteins, favorites, difficulty, description, highlighted, ingredients, incompatibilities
        case deliverableIngredients = "deliverable_ingredients"
        case undeliverableIngredients = "undeliverable_ingredients"
    }
}

typealias Genral = [GeneralRespone]
